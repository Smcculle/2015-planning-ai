...
public class TestSuite {
	...
	public static final int NODE_LIMIT = 30000;
...
//		new edu.uno.ai.planning.iw.IteratedWidthPlanner(),
	...
	public static final Benchmark[] BENCHMARKS = new Benchmark[]{
		...
		new Benchmark("bulldozer", "get-back-jack"),
...
//		new Benchmark("blocks", "tower-invert"),
//		new Benchmark("road", "road-test"),
//		new Benchmark("blocks", "bw-large"),
