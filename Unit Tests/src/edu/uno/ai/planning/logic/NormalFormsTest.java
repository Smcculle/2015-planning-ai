...
public class NormalFormsTest extends NormalForms {
	...
	public void toCNFTest() {
		...
		assertEquals(toCNF(new Conjunction(not_AvBvC_)), new Conjunction(new Disjunction(notA),new Disjunction(notB),new Disjunction(notC)));
		...
		assertEquals(toCNF(_ANotB_v_XY_v_BXNotY_), new Conjunction(new Disjunction(X,A), new Disjunction(B,Y,A), new Disjunction(X, notB)));
	...
	public void toDNFTest() {
		...
		// assertEquals(toDNF(emptyConjunction), emptyConjunction); // TODO Failing Edge Case: Expression's checking equals, otherNAB is NULL
		// assertEquals(toDNF(emptyDisjunction), emptyConjunction); // TODO Failing Edge Case: Expression's checking equals, otherNAB is NULL
		// assertEquals(toDNF((Conjunction)nullExpression), null); // TODO Failing Edge Case: Expression's checking equals, otherNAB is NULL
		...
		assertEquals(toDNF(new Conjunction(not_ABC_)), new Disjunction(new Conjunction(notA), new Conjunction(notB), new Conjunction(notC)));
