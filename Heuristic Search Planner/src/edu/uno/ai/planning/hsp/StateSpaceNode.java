 ...
 * 
 * This class contains an overridden equals 
 * and hashcode, thus it is not the same as Dr. Ware's original StateSpaceNode.
 * 
...
public class StateSpaceNode {
	...
	public boolean equals(Object obj) {
		...
		if (state.toExpression() == null) {
			if (other.state.toExpression() != null)
				return false;
		} else if (!state.toExpression().equals(other.state.toExpression()))
			return false;
		return true;
	}
